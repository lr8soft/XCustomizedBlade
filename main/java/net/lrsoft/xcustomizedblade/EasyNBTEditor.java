...
public class EasyNBTEditor extends JFrame{
	...
	public EasyNBTEditor(ItemStack input) {
		...
		JCheckBox iswitchB=new JCheckBox("妖刀");iswitchB.setBounds(x+10*h, y+28*h,60, 20);menu.add(iswitchB);
		JButton submit =new JButton("提交");submit.setBounds(x+10*h+60+100, y+20*h, 150, 150);
		try {
