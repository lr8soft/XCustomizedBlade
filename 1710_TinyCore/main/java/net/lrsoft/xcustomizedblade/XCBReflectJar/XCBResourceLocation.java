package net.lrsoft.xcustomizedblade.XCBReflectJar;

import org.apache.commons.lang3.Validate;

public class XCBResourceLocation {
    private final String resourceDomain;
    private final String resourcePath;
    public XCBResourceLocation(String p_i1292_1_, String p_i1292_2_)
    {
    ...
    public XCBResourceLocation(String p_i1293_1_)
    {
        String s1 = "minecraft";
    ...
    public boolean equals(Object p_equals_1_)
    {
        ...
        else if (!(p_equals_1_ instanceof XCBResourceLocation))
        {
            return false;
        }
        else
        {
        	XCBResourceLocation resourcelocation = (XCBResourceLocation)p_equals_1_;
